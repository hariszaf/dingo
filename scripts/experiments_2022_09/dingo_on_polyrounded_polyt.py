...
def sample_on_polyround_processed_polytope(network):
   ...
   with open("dingo_samples_polyround_transformation/dingo_polyround" + name + ".pckl", "wb") as dingo_steadystates_file: 
...
if __name__ == '__main__':
   ...
   current_directory = os.getcwd()
   path_to_net = current_directory + "/polyround_polytopes/" + file_name
